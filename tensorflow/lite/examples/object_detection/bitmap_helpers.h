...
#ifndef TENSORFLOW_LITE_EXAMPLES_OBJECT_DETECTION_BITMAP_HELPERS_H_
#define TENSORFLOW_LITE_EXAMPLES_OBJECT_DETECTION_BITMAP_HELPERS_H_
...
#endif  // TENSORFLOW_LITE_EXAMPLES_OBJECT_DETECTION_BITMAP_HELPERS_H_
